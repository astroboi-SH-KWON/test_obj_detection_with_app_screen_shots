...
class WandbLogger():
    """Log training runs, datasets, obj_detect_models, and predictions to Weights & Biases.
    ...
    obj_detect_models and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO obj_detect_models:
